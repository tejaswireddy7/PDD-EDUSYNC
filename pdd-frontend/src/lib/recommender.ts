...
const COURSE_DATABASE: Record<string, Record<string, RecommendedCourse[]>> = {
  Frontend: {
    Beginner: [
      ...
      {
        title: "Intro to React & Component States",
    ...
    Intermediate: [
      {
        title: "React Router & Global Context",
      ...
      {
        title: "TypeScript Essentials for Web",
        subject: "Typed Systems",
        progress: 0,
        time: "16 hrs",
        difficulty: "Intermediate",
        ai: true,
  ...
  Backend: {
    Beginner: [
      {
        title: "Intro to Node.js & REST API",
        subject: "JS Server",
        progress: 0,
        time: "14 hrs",
        difficulty: "Beginner",
      ...
      {
        title: "SQL Fundamentals & Relational DBs",
        subject: "Databases",
        progress: 0,
        time: "18 hrs",
        difficulty: "Beginner",
      ...
      {
        title: "Basics of Routing & HTTP Methods",
        subject: "Networking",
        progress: 0,
        time: "10 hrs",
        difficulty: "Beginner",
    ...
    Intermediate: [
      ...
      {
        title: "PostgreSQL Queries & Optimization",
        subject: "Databases",
        progress: 0,
        time: "15 hrs",
        difficulty: "Intermediate",
      ...
      {
        title: "Redis Caching & Task Queues",
        subject: "Performance",
        progress: 0,
        time: "12 hrs",
        difficulty: "Intermediate",
    ...
    Advanced: [
      ...
      {
        title: "Go Concurrency & Channels Deep-Dive",
        subject: "Backend Go",
        progress: 0,
        time: "24 hrs",
        difficulty: "Advanced",
  ...
  Mobile: {
    Beginner: [
      ...
      {
        title: "Flexbox Layouts in Mobile Screens",
        subject: "UI Design",
        progress: 0,
        time: "8 hrs",
        difficulty: "Beginner",
      ...
      {
        title: "Navigation Containers & Tabs",
        subject: "App Flow",
        progress: 0,
        time: "12 hrs",
        difficulty: "Beginner",
    ...
    Intermediate: [
      {
        title: "Advanced React Navigation v6",
        subject: "App Flow",
        progress: 0,
        time: "16 hrs",
        difficulty: "Intermediate",
      ...
      {
        title: "Native Features: Camera, GPS & Audio",
        subject: "Hardware APIs",
        progress: 0,
        time: "22 hrs",
        difficulty: "Intermediate",
        ai: false,
      ...
      {
        title: "State Management in Native Apps",
        subject: "Data Flow",
        progress: 0,
        time: "14 hrs",
        difficulty: "Intermediate",
    ...
    Advanced: [
      {
        title: "SwiftUI Mastery for iOS Platforms",
        subject: "Native iOS",
        progress: 0,
        time: "30 hrs",
        difficulty: "Advanced",
      ...
      {
        title: "Kotlin & Android Jetpack UI",
        subject: "Native Android",
        progress: 0,
        time: "32 hrs",
        difficulty: "Advanced",
        ai: false,
      ...
      {
        title: "Native Bridges & Performance Tuning",
        subject: "Advanced Core",
        progress: 0,
        time: "20 hrs",
        difficulty: "Advanced",
        ai: true,
  ...
  AI: {
    Beginner: [
      {
        title: "Python Fundamentals & Packages",
        subject: "Python Dev",
        progress: 0,
        time: "14 hrs",
        difficulty: "Beginner",
    ...
    Advanced: [
      {
        title: "Fine-Tuning Generative AI Models",
        subject: "LLM Systems",
        progress: 0,
        time: "35 hrs",
        difficulty: "Advanced",
      ...
      {
        title: "MLOps: CI/CD Pipeline for Models",
        subject: "AI DevOps",
        progress: 0,
        time: "26 hrs",
        difficulty: "Advanced",
...
const RESOURCE_DATABASE: Record<string, RecommendedResource[]> = {
  Frontend: [
    ...
    {
      title: "Next.js Core Web Vitals Optimization Guides",
  ...
  Backend: [
    ...
    {
      title: "PostgreSQL Window Functions Explained",
      type: "Technical Article",
      duration: "12 min",
    },
  ...
  Mobile: [
    {
      title: "React Native Performance Debugging Tools",
  ...
  AI: [
    ...
    {
      title: "Hugging Face LLM Pipeline Integration Guides",
      type: "Lab Exercise",
      duration: "25 min",
    },
  ],
...
const MILESTONE_DATABASE: Record<string, CareerMilestone[]> = {
  Frontend: [
    {
      title: "UI/UX Master",
      description: "Design a fully responsive 3-column dashboard grid",
      status: "active",
    },
    {
      title: "Component Architect",
      description: "Refactor global state using TypeScript structures",
      status: "locked",
    },
    {
      title: "Federation Lead",
      description: "Launch micro-frontends with perfect Web Vitals",
      status: "locked",
    },
  ],
  Backend: [
    {
      title: "REST Designer",
      description: "Build full CRUD REST API endpoints with Express",
      status: "active",
    },
    {
      title: "Docker Deployer",
      description: "Deploy localized database containers and Redis caching",
      status: "locked",
    },
    {
      title: "Kubernetes Master",
      description: "Launch enterprise microservice clusters",
      status: "locked",
    },
  ],
  Mobile: [
    {
      title: "Expo Pioneer",
      description: "Boot an interactive Expo application in the emulator",
      status: "active",
    },
    {
      title: "Hardware Orchestrator",
      description: "Access live location maps and camera APIs",
      status: "locked",
    },
    {
      title: "Performance Engineer",
      description: "Deploy native Bridges and minimize bundle weight",
      status: "locked",
    },
  ],
  AI: [
    {
      title: "Data Analyst",
      description: "Filter, clean, and visualize 50k rows using Pandas",
      status: "active",
    },
    {
      title: "PyTorch Builder",
      description: "Train a custom MLP classifier on localized inputs",
      status: "locked",
    },
    {
      title: "MLOps Architect",
      description: "Deploy high-volume LLM API endpoints to public cloud",
      status: "locked",
    },
  ],
};
...
function getDifficultyMultiplier(itemDifficulty: string, userProficiency: string): number {
...
export function getRecommendations(
  ...
  const scoredCourses = courseCandidates.map((course) => {
    ...
    const isDomainMatch =
      course.difficulty === proficiency &&
      COURSE_DATABASE[focusDomain]?.[proficiency]?.some((c) => c.title === course.title);
    const domainBoost = isDomainMatch ? 0.3 : 0.0;

    // Add target learning goal boost
    const isTargetGoal =
      targetLearningGoal && GOAL_COURSE_MAPPING[targetLearningGoal] === course.title;
