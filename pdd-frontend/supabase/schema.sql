...
('HTML5, CSS3, & Modern Grid', 'Web Basics', 0, '15 hrs', 'Beginner', true, array['#6366f1', '#818cf8'], 'https://www.youtube.com/embed/0xMQfnTU6oo', 'Frontend'),
('JavaScript Fundamentals & DOM', 'JS Core', 0, '22 hrs', 'Beginner', false, array['#f59e0b', '#fbbf24'], 'https://www.youtube.com/embed/hdI2bqOjy3c', 'Frontend'),
('Intro to React & Component States', 'React Framework', 0, '18 hrs', 'Beginner', true, array['#0ea5e9', '#38bdf8'], 'https://www.youtube.com/embed/Ke90Tje7VS0', 'Frontend'),
('React Router & Global Context', 'React Architecture', 0, '14 hrs', 'Intermediate', true, array['#6366f1', '#818cf8'], 'https://www.youtube.com/embed/Ul3y1LXxzdU', 'Frontend'),
('Tailwind CSS & Responsive Layouts', 'Styling Systems', 0, '8 hrs', 'Intermediate', false, array['#0d9488', '#2dd4bf'], 'https://www.youtube.com/embed/m7OWXtbiXX8', 'Frontend'),
('TypeScript Essentials for Web', 'Typed Systems', 0, '16 hrs', 'Intermediate', true, array['#2563eb', '#60a5fa'], 'https://www.youtube.com/embed/d56mG7DezGs', 'Frontend'),
('Next.js 14 App Router Mastery', 'Production Frameworks', 0, '25 hrs', 'Advanced', true, array['#6366f1', '#818cf8'], 'https://www.youtube.com/embed/wm5gMKuwSYk', 'Frontend'),
('Web Performance & Core Web Vitals', 'Performance', 0, '12 hrs', 'Advanced', false, array['#0d9488', '#2dd4bf'], 'https://www.youtube.com/embed/t5fjIW3tB00', 'Frontend'),
('Module Federation & Micro-Frontends', 'Web Architecture', 0, '30 hrs', 'Advanced', true, array['#2563eb', '#60a5fa'], 'https://www.youtube.com/embed/ICeH3uBGGeo', 'Frontend'),

('Intro to Node.js & REST API', 'JS Server', 0, '14 hrs', 'Beginner', true, array['#16a34a', '#4ade80'], 'https://www.youtube.com/embed/Oe421EPjeBE', 'Backend'),
('SQL Fundamentals & Relational DBs', 'Databases', 0, '18 hrs', 'Beginner', false, array['#0f172a', '#334155'], 'https://www.youtube.com/embed/7S_tz1z_5bA', 'Backend'),
('Basics of Routing & HTTP Methods', 'Networking', 0, '10 hrs', 'Beginner', true, array['#db2777', '#f472b6'], 'https://www.youtube.com/embed/iYM2zFP3Zn0', 'Backend'),
('Java Spring Boot Microservices', 'Enterprise Java', 0, '35 hrs', 'Intermediate', true, array['#6366f1', '#818cf8'], 'https://www.youtube.com/embed/35EQXmHKZYs', 'Backend'),
('PostgreSQL Queries & Optimization', 'Databases', 0, '15 hrs', 'Intermediate', false, array['#0d9488', '#2dd4bf'], 'https://www.youtube.com/embed/qw--VYLpxG4', 'Backend'),
('Redis Caching & Task Queues', 'Performance', 0, '12 hrs', 'Intermediate', true, array['#2563eb', '#60a5fa'], 'https://www.youtube.com/embed/jgpVdJB2sKQ', 'Backend'),
('Distributed Systems & Scalability', 'System Design', 0, '40 hrs', 'Advanced', true, array['#6366f1', '#818cf8'], 'https://www.youtube.com/embed/oSkTPzOGMuw', 'Backend'),
('Docker & Kubernetes Orchestration', 'DevOps', 0, '28 hrs', 'Advanced', false, array['#0ea5e9', '#38bdf8'], 'https://www.youtube.com/embed/rjjES5IsPdg', 'Backend'),
...
('State Management in Native Apps', 'Data Flow', 0, '14 hrs', 'Intermediate', true, array['#f59e0b', '#fbbf24'], 'https://www.youtube.com/embed/0-S5a0eXPoc', 'Mobile'),
('SwiftUI Mastery for iOS Platforms', 'Native iOS', 0, '30 hrs', 'Advanced', true, array['#f97316', '#fdba74'], 'https://www.youtube.com/embed/HXoVSbwWUIk', 'Mobile'),
('Kotlin & Android Jetpack UI', 'Native Android', 0, '32 hrs', 'Advanced', false, array['#0d9488', '#2dd4bf'], 'https://www.youtube.com/embed/6_wK_Ud8--0', 'Mobile'),
('Native Bridges & Performance Tuning', 'Advanced Core', 0, '20 hrs', 'Advanced', true, array['#2563eb', '#60a5fa'], 'https://www.youtube.com/embed/0-S5a0eXPoc', 'Mobile'),

('Python Fundamentals & Packages', 'Python Dev', 0, '14 hrs', 'Beginner', true, array['#2563eb', '#60a5fa'], 'https://www.youtube.com/embed/_uQrJ0TkZlc', 'AI'),
('Pandas & Numpy Data Wrangling', 'Data Prep', 0, '16 hrs', 'Beginner', false, array['#0d9488', '#2dd4bf'], 'https://www.youtube.com/embed/F6kmIpWWEdU', 'AI'),
('Basic Statistics & Probability', 'Math Foundations', 0, '12 hrs', 'Beginner', true, array['#a855f7', '#c084fc'], 'https://www.youtube.com/embed/xxpc-HPKN28', 'AI'),
('Neural Networks with PyTorch', 'Deep Learning', 0, '28 hrs', 'Intermediate', true, array['#6366f1', '#818cf8'], 'https://www.youtube.com/embed/V_xro1bcAuA', 'AI'),
('Natural Language Processing (NLP)', 'AI Focus', 0, '24 hrs', 'Intermediate', false, array['#db2777', '#f472b6'], 'https://www.youtube.com/embed/dIUTsFT2MeQ', 'AI'),
('Data Visualization with Recharts', 'Data Presenting', 0, '8 hrs', 'Intermediate', true, array['#0ea5e9', '#38bdf8'], 'https://www.youtube.com/embed/F6kmIpWWEdU', 'AI'),
('Fine-Tuning Generative AI Models', 'LLM Systems', 0, '35 hrs', 'Advanced', true, array['#a855f7', '#c084fc'], 'https://www.youtube.com/embed/V_xro1bcAuA', 'AI'),
('MLOps: CI/CD Pipeline for Models', 'AI DevOps', 0, '26 hrs', 'Advanced', false, array['#0d9488', '#2dd4bf'], 'https://www.youtube.com/embed/V_xro1bcAuA', 'AI'),
('Transformer Architectures & Attention', 'Neural Science', 0, '40 hrs', 'Advanced', true, array['#2563eb', '#60a5fa'], 'https://www.youtube.com/embed/V_xro1bcAuA', 'AI')
